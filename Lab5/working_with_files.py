...
first_group_file = "first_group.txt"
second_group_file = "second_group.txt"
# readFiles()
# write_to_file(second_group_file)
# append_to_file("first_group.txt")
# search_file_in_dir(first_group_file)
# search_text_in_file(first_group_file, "mis")
sort_marks_in_file(first_group_file)